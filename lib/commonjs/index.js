...
// };
const triggerPaypalCheckout = args => _reactNative.NativeModules.PaypalCheckoutTrigger.triggerPaypalCheckout(args.paymentId, args.onMessage, args.needDetails);
